      ...
      <div className="mt-10 glass-card rounded-2xl p-6 border-l-2 border-[#3DDC84]">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
          <div className="shrink-0">
            <p className="text-[#3DDC84] font-bold text-2xl">300+</p>
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            Solved 300+ data structures &amp; algorithms problems across <span className="text-white font-medium">LeetCode</span>, <span className="text-white font-medium">Codeforces</span>, CodeChef &amp; GeeksforGeeks. Strong foundation in arrays, trees, graphs, DP &amp; sorting algorithms.
          </p>
