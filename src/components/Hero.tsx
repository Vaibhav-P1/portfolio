    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden px-6 pt-24 pb-16 w-full">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          ...
          {/* Main headline */}
          <div className="mb-4">
            <h1 className="text-[clamp(3.5rem,10vw,8.5rem)] font-black text-white leading-[0.9] tracking-tighter">
              Vaibhav
            </h1>
            <h1 className="text-[clamp(3.5rem,10vw,8.5rem)] font-black leading-[0.9] tracking-tighter gradient-text">
              Pandey
            </h1>
          </div>
          ...
          {/* Brief tagline */}
          <p className="text-base md:text-lg text-white/50 font-light max-w-2xl leading-relaxed mb-12">
          ...
          {/* Stats row */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/[0.06] rounded-2xl overflow-hidden max-w-3xl">
            {[
